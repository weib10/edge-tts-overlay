...
public partial class TextEntryWindow : Window
{
    ...
    { InitializeComponent(); _settings = settings; _submit = submit; if (initialText is not null) OriginalBox.Text = initialText; else try { if (System.Windows.Clipboard.ContainsText()) OriginalBox.Text = System.Windows.Clipboard.GetText(); } catch { } OriginalBox.Focus(); }
